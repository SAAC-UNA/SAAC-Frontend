...
export function TooltipTrigger({ asChild = false, children }: TooltipTriggerProps) {
  ...
  return (
    <div
      ref={wrapperRef}
      onMouseEnter={() => wrapperRef.current && handleOpen(wrapperRef.current.getBoundingClientRect())}
      onMouseLeave={handleClose}
      onFocus={() => wrapperRef.current && handleOpen(wrapperRef.current.getBoundingClientRect())}
      onBlur={handleClose}
    >
      {children}
    </div>
    ...
    switch (side) {
      case 'bottom':
        return {
          ...
          left: align === 'center' ? cx : align === 'start' ? triggerRect.left : triggerRect.right,
        };
      case 'top':
        return {
      ...
      case 'right':
        return {
          ...
          top: align === 'center' ? cy : align === 'start' ? triggerRect.top : triggerRect.bottom,
        };
      case 'left':
        return {
