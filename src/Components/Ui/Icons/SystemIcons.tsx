...
export const SystemIcons = {
  ...
  actions: {
    ...
    copyLink: ({ className, size, color }: IconProps) => (
      <svg
        className={`${getSizeClasses(size)} ${className || ""}`}
        viewBox="0 0 24 24"
        fill={color || "currentColor"}
      >
        <path d="M20.25 3h-12a.75.75 0 0 0-.75.75V7.5H3.75a.75.75 0 0 0-.75.75v12a.75.75 0 0 0 .75.75h12a.75.75 0 0 0 .75-.75V16.5h3.75a.75.75 0 0 0 .75-.75v-12a.75.75 0 0 0-.75-.75Zm-.75 12h-3V8.25a.75.75 0 0 0-.75-.75H9v-3h10.5V15Z" />
      </svg>
    ),
  ...
  interface: {
    ...
    /** Chevron breadcrumb - Separador para navegación de breadcrumb */
    chevronBreadcrumb: ({ className, size, color }: IconProps) => (
      <svg
        className={`${getSizeClasses(size)} ${className || ""}`}
        viewBox="0 0 20 20"
        fill={color || "currentColor"}
    ...
    /** Grip vertical - Manija de arrastre (drag handle) */
    gripVertical: ({ className, size, color }: IconProps) => (
      <svg
        className={`${getSizeClasses(size)} ${className || ""}`}
        viewBox="0 0 24 24"
        fill={color || "currentColor"}
      >
        <path d="M9.5 5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Zm0 7a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Zm0 7a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Zm8-14a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Zm0 7a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Zm0 7a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z" />
      </svg>
    ),

    /** Paperclip - Para adjuntos y archivos */
    paperclip: ({ className, size, color }: IconProps) => (
      <svg
        className={`${getSizeClasses(size)} ${className || ""}`}
        viewBox="0 0 24 24"
        fill="none"
