        ...
        <div className="space-y-6">
              ...
              <Card className="p-6 space-y-6">
                  ...
                  <div className="flex items-center gap-3">
                    {isFlexible ? (
                      <div className="rounded-corner bg-blanco-una px-3 py-1.5 border border-gris-una/15 text-center">
                        <p
                          className={`${TYPOGRAPHY.form.helper} text-gris-una`}
                        >
                          Elementos
                        </p>
                        <p
                          className={`${TYPOGRAPHY.form.helper} font-semibold text-gris-una`}
                        >
                          {formData.selectedElements.length}
                        </p>
                      </div>
                    ) : (
                      <>
                ...
                {(errors.proceso ||
                  ...
                  <div className="space-y-2">
                    {errors.proceso && (
                      <div
                        className={`${TYPOGRAPHY.form.helper} text-rojo-una-2 bg-rojo-una-2/5 border border-rojo-una-2/20 rounded-corner px-3 py-2`}
                      >
                        {errors.proceso}
                      </div>
                    )}
                  ...
                  <>
                    ...
                    <div>
                      <MultiSelect
                        ...
                        onChange={(vals) => {
                          ...
                          const filtered = formData.selectedEvidences.filter(
                            (id) => {
                              const ev = criteriaEvidences.find(
                                (e) => e.evidencia_id === id,
                              );
                    ...
                    <div>
                      <MultiSelect
                        ...
                        onChange={(vals) =>
                          updateFormData({
                            selectedEvidences: vals.map((v) => parseInt(v, 10)),
                          })
                        }
                        placeholder={
              ...
              <Card className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <p
                    className={`mt-1.5 ${TYPOGRAPHY.form.helper} text-gris-una`}
                  >
                    Todos los usuarios del rol recibirán las evidencias
                    asignadas.
                  </p>
                </div>
              </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
              ...
              <Card className="p-6 space-y-4 h-full">
                ...
                >
                  Fecha límite
                  <span
                    className={`ml-2 ${TYPOGRAPHY.form.helper} font-normal text-gris-una`}
                  >
                    (opcional)
                  </span>
                </h2>
                <DateRangePicker
                  ...
                  onChange={(range) =>
                    updateFormData({ fecha_limite: range.to ?? "" })
                  }
                  minDate={today}
              ...
              <Card className="p-6 space-y-4 h-full">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    updateFormData({ comentario: e.target.value })
                  }
          ...
          <ScrollReveal delay={0.14}>
            <DataTable
                  ...
                  ? {
                      ...
                      render: () =>
                        selectedAvatars.length > 0 ? (
                          ...
                          <span
                            className={`${TYPOGRAPHY.table.cell} text-gris-una/50`}
                          >
                            Sin destinatarios
                          </span>
                        ),
              ...
              emptyMessage={
                <p
                  className={`${TYPOGRAPHY.emptyState.descriptionCompact} text-gris-una py-6 text-center`}
                >
                  {isFlexible
          ...
          {!duplicatesValidating &&
            (activeDuplicates.length > 0 || completedDuplicates.length > 0) && (
                ...
                {activeDuplicates.length > 0 && (
                  <Card className="overflow-hidden border-2 border-warning-ring bg-blanco-una">
                    <div className="px-6 pt-6 pb-2">
                      ...
                      <p
                        className={`mt-1 ${TYPOGRAPHY.table.helper} text-gris-una`}
                      >
                        Usuarios con asignaciones pendientes en progreso. No se
                        pueden reasignar.
                      </p>
                    </div>
                    <DataTable<DuplicateGroupRow>
                      ...
                      columns={[
                        {
                          ...
                          render: (_, row) => (
                            <div className="flex items-center gap-3">
                              ...
                              <p
                                className={`${TYPOGRAPHY.table.cell} font-semibold text-warning`}
                              >
                                {row.usuario_nombre}
                              </p>
                            </div>
                      ...
                      expandableRow={(item): ExpandableChildItem[] =>
                        item.evidences.map((dup) => ({
                          ...
                          action: (
                            <span
                              className={`text-gris-una shrink-0 ${TYPOGRAPHY.table.cell}`}
                            >
                    ...
                    <div className="px-6 pt-6 pb-2">
                      ...
                      <div className="flex items-center justify-between gap-4 mt-1">
                        ...
                        <label className="flex items-center gap-2 cursor-pointer select-none shrink-0">
                          ...
                          />
                          <span
                            className={`${TYPOGRAPHY.form.helper} text-info-dark`}
                          >
                            Seleccionar todos
                          </span>
                        </label>
                      ...
                      columns={[
                        {
                          ...
                          render: (_, row) => (
                            <input
                              type="checkbox"
                              checked={row.evidences.every(
                                (e: DuplicateAssignment) =>
                                  !excludedCompletedPairs.some(
                                    (p) =>
                                      p.usuario_id === e.usuario_id &&
                                      p.evidencia_id === e.evidencia_id,
                                  ),
                              )}
                              onChange={(e) => {
                                e.stopPropagation();
                                toggleAllCompletedPairsForUser(row.evidences);
                              }}
                              className="w-3 h-3 rounded border-info-ring text-info focus:ring-info cursor-pointer"
                        ...
                        },
                        {
                          ...
                          render: (_, row) => (
                            <div className="flex items-center gap-3">
                              ...
                              <p
                                className={`${TYPOGRAPHY.table.cell} font-semibold text-info-dark`}
                              >
                                {row.usuario_nombre}
                              </p>
                            </div>
                      ...
                      expandableRow={(item): ExpandableChildItem[] =>
                        item.evidences.map((dup: DuplicateAssignment) => {
                          const isExcluded = excludedCompletedPairs.some(
                            (p) =>
                              p.usuario_id === dup.usuario_id &&
                              p.evidencia_id === dup.evidencia_id,
                          );
                          return {
                            ...
                            action: (
                              <span
                                className={`text-negro-una shrink-0 ${TYPOGRAPHY.table.cell}`}
                              >
                                {formatDateShort(dup.fecha_asignacion)}
                              </span>
                            ),
