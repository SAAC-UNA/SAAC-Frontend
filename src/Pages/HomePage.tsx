...
const developers = [
  { name: 'Ian Villegas Jiménez', role: 'Desarrollador', icon: <CodeIcon className="w-6 h-6 text-azul-una" /> },
  { name: 'Marisol Hidalgo Murillo', role: 'Desarrolladora', icon: <PaintIcon className="w-6 h-6 text-rojo-una" /> },
  { name: 'José Jara Arias', role: 'Desarrollador', icon: <DatabaseIcon className="w-6 h-6 text-warning" /> },
  { name: 'Cristina Zúñiga Cárdenas', role: 'Desarrolladora', icon: <MonitorIcon className="w-6 h-6 text-info" /> },
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full mx-auto">
          ...
          <div className="text-center mb-10 flex flex-col items-center w-full">
            ...
            >
              ...
              <div className="relative flex items-center justify-center w-18 h-18 rounded-[2rem] bg-gradient-to-br from-rojo-una to-rojo-una-2 shadow-2xl ring-8 ring-white/50">
            ...
            >
              ...
              <span className="px-6 py-2.5 rounded-full backdrop-blur-md bg-white/50 text-azul-una font-bold text-sm tracking-[0.1em] uppercase border border-azul-una/20 shadow-sm">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-5 max-w-4xl mx-auto">
              {developers.map((dev, i) => (
                ...
                >
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-gray-50 to-gray-200 border border-white shadow-sm flex items-center justify-center mr-4 group-hover:rotate-12 transition-transform duration-300">
                    {dev.icon}
                  </div>
                  <div className="flex flex-col text-left">
                    <h4 className="text-base font-extrabold text-gray-800 tracking-tight leading-none mb-1">
                      {dev.name}
                    </h4>
